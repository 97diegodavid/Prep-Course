...
function agregarAmigo (usuario, nuevoAmigo) {
  ...
  // Tu código:
  /*let nuevoArray =[];
  nuevoArray = usuario.amigos; 
  nuevoArray[usuario.amigos.length]= nuevoAmigo; 
  return usuario ; */
...
function pasarUsuarioAPremium (usuarios) {
  ...
  for(let i =0; i<usuarios.length; i++){
        usuario =  usuarios[i];
        usuario.esPremium= true;      // usuarios[i].esPremium 
  }
  return usuarios; */
  /*
  for( let i = 0; i<usuarios.length; i++){
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  producto["calcularPrecioDescuento"] = function (){
    ...
    let total =   producto.precio - descuento ; 
    return  total;
  }; 
  return producto ;  */ 
  /*
  ...
  producto["calcularPrecioDescuento"] =  metodo ; 
  return producto ; 
